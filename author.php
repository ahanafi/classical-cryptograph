...
<head>
    ...
    <title>Classical Cryptograph - The Author</title>
            ...
            <div id="content">
                ...
                <div id="author" class="container-fluid p-lg-3" style="margin-top: 10%;">
                    ...
                    <div class="text-center">
                        ...
                        <p class="lead text-white font-weight-bold mb-1 mt-3">
                            <a href="https://ahanafi.github.io/index2.html" target="_blank" class="text-white">Ahmad Hanafi</a>
                        </p>
                        <p class="text-white mb-0">2017102020</p>
                        <p class="text-white font-weight-bold mb-3">TI - SE 1/6</p>
                        <br>
